var VueRadioToggleButtons = (function (Vue) {
	'use strict';
	...
	*/
	...
	function isColor(color$1) {
	    if (typeof color$1 !== 'string' || color$1.length === 0) {
	        return false;
	    }
	    try {
	        color(color$1);
	...
	***************************************************************************** */
	...
	var RadioToggle = /** @class */ (function (_super) {
	    ...
	    Object.defineProperty(RadioToggle.prototype, "style", {
	        get: function () {
	            var _a = this, color$1 = _a.color, textColor = _a.textColor, selectedTextColor = _a.selectedTextColor, disabled = _a.disabled, isHovered = _a.isHovered, isSelected = _a.isSelected;
	            var mainColor = color(color$1);
	            ...
	            if (!disabled && isSelected) {
	                ...
	                if (isHovered) {
	                    ...
	                    styles.backgroundColor = color$1;
	                    styles.borderColor = color$1;
	                }
	            }
	            if (disabled) {
	...
	var RadioToggleButtons = /** @class */ (function (_super) {
	    __extends(RadioToggleButtons, _super);
	...
	return VueRadioToggleButtons;

}(Vue));
//# sourceMappingURL=vue-radio-toggle-buttons.web.js.map
